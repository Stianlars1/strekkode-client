// import { Modal } from "@/components/modalv1/modal";
  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={onClose} hasCloseBtn={true}>
        <div className="modal__content-about-us">
          <h2>Om oss</h2>
          <h3>Hei, jeg er Stian Larsen! 👋</h3>
          <p>
            Som en {new Date().getFullYear() - 1997} år gammel fullstack
            utvikler med en brennende lidenskap for teknologi, har jeg alltid
            vært drevet av en nysgjerrighet for hvordan digitale løsninger kan
            forenkle hverdagen vår. Med dette i hjertet, er jeg stolt av å
            introdusere{" "}
            <Link
